...
double Lots_fixed_StochKeltner2=2.0;           // StochKeltner 2
double Lots_fixed_StochKeltner3=3.0;           // StochKeltner 3
...
int TakeProfit_MiniShortII=300;         // Mini-Short Double Trouble II
int TakeProfit_MiniShortIII=200;        // Mini-Short Reversal
int TakeProfit_MiniLong10DayBO=400;     // Mini-Long 10DayBO Daily
int TakeProfit_MiniLongADXDay=200;        // Mini-Long ADXDay Daily
int TakeProfit_MiniOsMAHiLo=0;          // MiniOsMAHiLo
int TakeProfit_StochADX1=150;           // StochADX 1 (market immediate)
int TakeProfit_StochADX2=220;           // StochADX 2 (market immediate)
int TakeProfit_StochADX3=100;           // StochADX 3 (market delayed)
int TakeProfit_StochKeltner1=100;       // StochKeltner 1
int TakeProfit_StochKeltner2=140;       // StochKeltner 2
int TakeProfit_StochKeltner3=100;       // StochKeltner 3
int TakeProfit_Vegas1=140;              // Vegas 1
int TakeProfit_Vegas2=140;              // Vegas 2
int TakeProfit_Vegas3=160;              // Vegas 3
int TakeProfit_Vegas4=250;              // Vegas 4
...
int TakeProfit_MAStochRSI2=210;      // MAStochRSI 2
...
int TakeProfit_ADXTrend1=140;        // ADXTrend 1 
int TakeProfit_ADXTrend2=280;        // ADXTrend 2
int TakeProfit_ADXTrend3=740;        // ADXTrend 3
...
int StopLoss_MiniShortI=12;          // Mini-Short Double Trouble I (above high/below low)
int StopLossMAX_MiniShortI=42;       // pips MAXIMUM stop loss for Mini-Short Double Trouble I 

int StopLoss_MiniShortII=12;         // Mini-Short Double Trouble II (above high/below low)
int StopLossMAX_MiniShortII=45;      // pips MAXIMUM stop loss for Mini-Short Double Trouble II 

int StopLoss_MiniShortIII=10;        // Mini-Short Reversal (above high / below low)
int StopLossMAX_MiniShortIII=45;     // pips MAXIMUM stop loss for Mini-Short Reversal

int StopLoss_MiniLong10DayBO=45;     // Mini-Long 10DayBO Daily (above high/ below low)
int StopLossMAX_MiniLong10DayBO=100; // pips MAXIMUM stop loss for Mini-Long 10DayBO Daily 

int StopLoss_MiniLongADXDay=100;     // Mini-Long ADXDay Daily (above high/ below low)

int StopLoss_MiniOsMAHiLo=19;         // MiniOsMAHiLo (above high / below low)
int StopLossMAX_MiniOsMAHiLo=50;    // MAX s/l MiniOsMAHiLo
...
int StopLoss_StochKeltner=38;        // StochKeltner

int StopLoss_Vegas=40;              //  Vegas 1,2,3,4

int StopLossMAX_RSIScalp=50;          //  RSI Scalper

int StopLoss_MAStochRSI=42;           //  MAStochRSI
int StopLoss_PSARASC=45;              //  PSARASC 1
int StopLoss_PMI30=35;                  //  PMI30 1,2
int StopLoss_PMI60=45;                  //  PMI60 1,2
int StopLoss_ADXTrend=125;             //  ADXTrend 1,2,3
int StopLoss_HighProb4=150;           //  HighProb4 1,2,3
  
// Trailing Stop List:

int TrailingStop_MiniShortI=55;      // Mini-Short Double Trouble I 
int TrailingStop_MiniShortII=72;     // Mini-Short Double Trouble II
int TrailingStop_MiniShortIII=50;    // Mini-Short Reversal
int TrailingStop_MiniLong10DayBO=70; // Mini-Long 10DayBO Daily
int TrailingStop_MiniLongADXDay=70; // Mini-Long ADXDay Daily
int TrailingStop_MiniOsMAHiLo=45;    // MiniOsMAHiLo
int TrailingStop_StochADX1=60;       // StochADX 1 (market immediate)
int TrailingStop_StochADX2=65;       // StochADX 2 (market immediate)
int TrailingStop_StochADX3=55;       // StochADX 3 (market delayed)
int TrailingStop_StochKeltner1=50;   // StochKeltner 1
int TrailingStop_StochKeltner2=60;   // StochKeltner 2
int TrailingStop_StochKeltner3=50;   // StochKeltner 3
...
int TrailingStop_ADXTrend1=70;      //  ADXTrend 1
int TrailingStop_ADXTrend2=140;      //  ADXTrend 2
int TrailingStop_ADXTrend3=260;      //  ADXTrend 3
//int TrailingStop_HighProb41=0;      //  HighProb4 1
int TrailingStop_HighProb42=90;      //  HighProb4 2
int TrailingStop_HighProb43=140;      //  HighProb4 3

// Dynamic Start List

int DynamicTrailMinimum=20;           // pips minimum dynamic trail (universally smallest dynamic trail achieveable)

int DynamicStart_MiniShortI=120;      // Mini-Short Double Trouble I
int DynamicStart_MiniShortII=180;     // Mini-Short Double Trouble II
int DynamicStart_MiniShortIII=110;    // Mini-Short Reversal
int DynamicStart_MiniLong10DayBO=300; // Mini-Long 10DayBO
int DynamicStart_MiniLongADXDay=140;  // Mini-Long ADXDay
int DynamicStart_MiniOsMAHiLo=100;    // MiniOsMAHiLo
int DynamicStart_StochADX1=55;       // StochADX 1 (market immediate)
int DynamicStart_StochADX2=170;      // StochADX 2 (market immediate)
...
int DynamicStart_StochKeltner3=60;   // StochKeltner 3
int DynamicStart_Vegas1=90;           // Vegas 1
int DynamicStart_Vegas2=100;          // Vegas 2
int DynamicStart_Vegas3=100;          // Vegas 3
int DynamicStart_Vegas4=140;          // Vegas 4
...
int DynamicStart_ADXTrend1=70;       // ADXTrend 1
int DynamicStart_ADXTrend2=180;      // ADXTrend 2
int DynamicStart_ADXTrend3=330;      // ADXTrend 3
//int DynamicStart_HighProb41=0;       // HighProb4 1
int DynamicStart_HighProb42=190;      // HighProb4 2
...
int DynamicRatio_MiniShortIII=3;      // Mini-Short Reversal
...
// Associated Fixed-Stops Parameters List:
 ...
 // MiniShortI
int ProfitPointFS_MiniShortI1=22;      // pips PROFIT after which LockProfitFS_MiniShortI takes into effect for MiniShortI
...
int LockProfitFS_MiniShortI2=22;       // pips lock-in GAIN for MAScalp after ProfitPointFS_MiniShortI2 is hit

 // MiniShortII
int ProfitPointFS_MiniShortII1=19;     // pips PROFIT after which LockProfitFS_MiniShortII takes into effect for MiniShortII
...
int LockProfitFS_MiniShortII2=25;      // pips lock-in GAIN for MAScalp after ProfitPointFS_MiniShortII2 is hit
 ...
 // MiniShortIII
int ProfitPointFS_MiniShortIII=32;    // pips PROFIT after which LockProfitFS_MiniShortIII takes into effect for MiniShortIII
int LockProfitFS_MiniShortIII=6;      // pips lock-in GAIN for MAScalp after ProfitPointFS_MiniShortIII is hit

 // MiniLong10DayBO
int ProfitPointFS_MiniLong10DayBO=50; // pips PROFIT after which LockProfitFS_MiniLong10DayBO takes into effect for MiniLong10DayBO
int LockProfitFS_MiniLong10DayBO=5;   // pips lock-in GAIN for MiniLong 10DayBO

 // MiniLongADXDay
int ProfitPointFS_MiniLongADXDay=65;  // pips PROFIT after which LockProfitFS_MiniLongADXDay takes into effect for MiniLongADXDay
int LockProfitFS_MiniLongADXDay=24;    // pips lock-in GAIN for MiniLong ADXDay 

 // MiniOsMAHiLo
int ProfitPointFS_MiniOsMAHiLo1=22;   // if profit is less than this value at BB-touch, reset t/p to 
int TakeProfitNEW_MiniOsMAHiLo1=110;   // new t/p if profit is less than ProfitPointFS_MiniOsMAHiLo1 at time of BB-touch
int ProfitPointFS_MiniOsMAHiLo2=14;   // pips profit required to adjust s/l to LockProfitFS_MiniOsMAHiLo2
...
int ProfitPointFS_Lot2_StochADX=21;   // pips PROFIT after which LockProfitFS_Lot2_StochADX takes into effect for StochADX 2
int LockProfitFS_Lot2_StochADX=3;     // pips lock-in GAIN for StochADX
...
int LockProfitFS_Lot3_StochADX=4;     // pips lock-in GAIN for StochADX
 ...
 // StochKeltner
int ProfitPointFSMIN_StochKeltner=15;  // pips minimum profit to qualify s/l to be moved to LockProfitFS_StochKeltner1 after touch of Keltner centerline
 
int ProfitPointFS_StochKeltner1=21;   // pips PROFIT after which LockProfitFS_StochKeltner1 takes into effect for StochKeltner 1, 2, 3
...
int LockProfitFS_StochKeltner2=7;    // pips lock-in GAIN for StochKeltner 1, 2, 3

 // Vegas
// Vegas Lot 1
int ProfitPointFS_Lot1_Vegas=36;       // pips PROFIT after which LockProfitFS_Lot1_Vegas takes into effect for Vegas Order 1
int LockProfitFS_Lot1_Vegas=4;         // pips lock-in GAIN for Vegas Order 1 after ProfitPointFS_Lot1_Vegas is hit
 // Vegas Lot 2
...
int LockProfitFS_Lot2_Vegas=12;         // pips lock-in GAIN for Vegas Order 2 after ProfitPointFS_Lot2_Vegas is hit
 // Vegas Lot 3
int ProfitPointFS_Lot3_Vegas=36;       // pips PROFIT after which LockProfitFS_Lot3_Vegas takes into effect for Vegas Order 3
int LockProfitFS_Lot3_Vegas=4;         // pips lock-in GAIN for Vegas Order 3 after ProfitPointFS_Lot3_Vegas is hit
 // Vegas Lot 4
...
int LockProfitFS_Lot2_RSIScalp1=8;     // pips lock-in GAIN for RSIScalp order 2 after ProfitPointFS_Lot2_RSIScalp1 is hit
...
int LockProfitFS_Lot2_RSIScalp2=25;    // pips lock-in GAIN for RSIScalp order 2 after ProfitPointFS_Lot2_RSIScalp2 is hit
 // RSIScalp Lot 3
int ProfitPointFS_Lot3_RSIScalp1=29;   // pips profit target after which to lock in LockProfitFS_Lot3_RSIScalp1 profits, order 3
int LockProfitFS_Lot3_RSIScalp1=13;     // pips lock-in GAIN for RSIScalp order 3 after ProfitPointFS_Lot3_RSIScalp1 is hit
...
int LockProfitFS_Lot3_RSIScalp2=25;    // pips lock-in GAIN for RSIScalp order 3 after ProfitPointFS_Lot3_RSIScalp2 is hit
 ...
 // MAStochRSI Lot 1
int ProfitPointFS_Lot1_MAStochRSI1=21;  // pips PROFIT after which LockProfitFS_Lot1_MAStochRSI takes into effect for MAStochRSI Order 1
...
int LockProfitFS_Lot2_MAStochRSI3=25;    // pips lock-in GAIN for MAStochRSI
 // MAStochRSI Lot 3
int ProfitPointFS_Lot3_MAStochRSI1=40;  // pips PROFIT after which LockProfitFS_Lot3_MAStochRSI takes into effect for MAStochRSI Order 3
...
int LockProfitFS_Lot3_MAStochRSI3=25;    // pips lock-in GAIN for MAStochRSI
 ...
 // PSARASC
// PSARASC Lot 1
int ProfitPointFS_PSARASC1=28;       // pips PROFIT after which LockProfitFS_PSARASC takes into effect for PSARASC Orders
int LockProfitFS_PSARASC1=1;         // pips lock-in GAIN for PSARASC Orders after ProfitPointFS_PSARASC is hit
int ProfitPointFS_PSARASC2=48;       // pips PROFIT after which LockProfitFS_PSARASC takes into effect for PSARASC Orders
int LockProfitFS_PSARASC2=10;         // pips lock-in GAIN for PSARASC Orders after ProfitPointFS_PSARASC is hit

 // PMI30
 // PMI30 Lot 1
int ProfitPointFS_Lot1_PMI30=21;           // pips PROFIT after which LockProfitFS_Lot1_PMI takes into effect for PMI Order 1
int LockProfitFS_Lot1_PMI30=4;             // pips lock-in GAIN for PMI Order 1 after ProfitPointFS_Lot1_PMI is hit
 // PMI30 Lot 2
...
int LockProfitFS_Lot2_PMI60=12;            // pips lock-in GAIN for PMI Order 2 after ProfitPointFS_Lot2_PMI is hit
 ...
 // ADXTrend
// ADXTrend Lot 1
int ProfitPointFS_Lot1_ADXTrend=42;      // pips PROFIT after which LockProfitFS_Lot1_ADXTrend takes into effect for ADXTrend Order 1
int LockProfitFS_Lot1_ADXTrend=5;        // pips lock-in GAIN for ADXTrend Order 1 after ProfitPointFS_Lot1_ADXTrend is hit
 // ADXTrend Lot 2
int ProfitPointFS_Lot2_ADXTrend=62;      // pips PROFIT after which LockProfitFS_Lot2_ADXTrend takes into effect for ADXTrend Order 2
int LockProfitFS_Lot2_ADXTrend=12;       // pips lock-in GAIN for ADXTrend Order 2 after ProfitPointFS_Lot2_ADXTrend is hit
 // ADXTrend Lot 3
int ProfitPointFS_Lot3_ADXTrend=72;      // pips PROFIT after which LockProfitFS_Lot3_ADXTrend takes into effect for ADXTrend Order 3
int LockProfitFS_Lot3_ADXTrend=7;        // pips lock-in GAIN for ADXTrend Order 3 after ProfitPointFS_Lot3_ADXTrend is hit
...
int TES_Vegas=4;                       // pips to increment existing s/l at the beginning of the hour 
...
int TES_ADXTrend=3;                       // pips to increment existing s/l at the beginning of the hour 
...
int BlackOutHourEndMiniShortI=2;         // hour to end blackout of Mini Short I (set to -1 to turn off)

int MAMiniShortITimeframe=PERIOD_H1;      // Timeframe

int MAMiniShortIslowPeriod=12;            // SMA() acts as base line for MiniShortI
int MAMiniShortIslowShift=1;              // Shift
...
int BlackOutHourBeginMiniShortII=20;       // hour to begin blackout of MiniShort II
int BlackOutHourEndMiniShortII=22;         // hour to end blackout of MiniShort II (set to -1 to turn off)

int MAMiniShortIITimeframe=PERIOD_H1;      // Timeframe

int MAMiniShortIIslowPeriod=21;            // SMA() acts as base line for MiniShortII
int MAMiniShortIIslowShift=0;              // Shift
int MAMiniShortIIslowMethod=MODE_SMA;      // Mode
int MAMiniShortIIslowPrice=PRICE_CLOSE;    // Method

int TriggerPipsMiniShortII=18;             // pips above SMA/price cross to execute pending order
...
int PeriodMiniShortIII=20;                 // hours in scanning period to determine whether subsequent high is a maximum
int TriggerMiniShortIII=22;                // pips above/below subsequent hour's low/high to trigger order execution

int BlackOutPeriodMiniShortIII=10;          // hours after the submission of a MiniShortIII order to accept another trigger 
...
int PeriodMiniLong10DayBO=14;            // days in scanning range to determine new high/low
int TriggerMiniLong10DayBO=105;           // pips below high/ above low at which to trigger order 
...
int ADXDayOsMAslow=86;             // ADXDay OsMA EMA slow period
int ADXDayOsMAsignal=16;            // ADXDay OsMA SMA signal period
...
int BlackoutPeriodMiniLongADXDay=1;        // days to prevent a new ADXDay OsMA order 
...
int BlackOutHourBeginMiniOsMAHiLo=19;       // hour to begin blackout
int BlackOutHourEndMiniOsMAHiLo=22;         // hour to end blackout(set to -1 to turn off)
...
double MiniOsMAHiLoSDLimit=0.0030;         // maximum value of standard deviation allowed
...
int WindowPeriodStochADX=5;                // hours in window of opportunity for triggers to be received (array max 10)
int WindowPeriodStochADX2=18;               // hours in window of opportunity for ATRStop friendliness
...
int WindowPeriodStochKeltner1=2;           // hours in window of opportunity for Part 1 triggers to be received
...
double StochKeltnerMultiplier=2.25;         // Multiplier for Keltner Channels
...
int StochKeltnerqPeriod = 6;              // q Period for DS_Stochastics
int StochKeltnerrPeriod = 20;              // r Period for DS_Stochastics
int StochKeltnerEMAfast = 4;               // EMA fast for DS_Stochastics
...
double StochKeltnerATRRatioMax=2.1;        // maximum ATR Ratio above which to deactivate for blackout period
...
int VegasMASpan=82;                      // pips away from MA(169) line to form upper/lower Vegas lines
...
double RSIhigh3=56.0;                // high RSI value      (Order 3, buy on bullish ZLMA X)
double RSIlow3=44.0;                 // low RSI value       (Order 3, sell on bearish ZLMA X)
...
int WindowPeriodMAStochRSI=5;           // hours in WoO for ATRStop friendliness (Orders 2 & 3)
...
int PSARASCRisk=2;                        // ASCTrend Risk
...
int WindowPeriod2ADXTrend=8;                // hours in WoO for Awe to agree after mandatory delay had passed
...
double HighProb4SDLimit=0.0125;               // no trades above this SD level
...
int WindowPeriodHighProb4=6;                 // hours for OsMA, PMI, SD to be in agreement & PMI+SD to be under max level
