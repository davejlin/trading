...
extern int MAMediPeriod=9;
extern int MAMediShift=0;
extern int MAMediMethod=MODE_SMA;
extern int MAMediPrice=PRICE_CLOSE;
...
//Calculate Indicators
 ...
 double medi1=iMA(NULL,0,MAMediPeriod,MAMediShift,MAMediMethod,MAMediPrice,1); 
 double medi2=iMA(NULL,0,MAMediPeriod,MAMediShift,MAMediMethod,MAMediPrice,2);  
...
//
    if(fast1>slow1)
    {
     if(medi1>slow1&&medi2<slow2&&MathAbs(fast1-slow1)>=(MACDdiff*Point))
