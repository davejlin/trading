...
extern int LookBackPeriod=20;        // number of bars to look-back to determine swing high/low
...
extern double PART =0.010;           // percentage of account balance at risk per trade
...
extern int StopLoss=35;              // pips initial SL (use negative number if not desired)
...
extern int SLMove=6;                 // pips to move SL to BE+SLMove after SLProfit is reached
