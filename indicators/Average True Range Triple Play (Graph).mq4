...
extern color ATR1_Color=Blue;  // color for the first ATR
extern color ATR2_Color=Red;  // color for the second ATR
extern color ATR3_Color=Lime;  // color for the third ATR

double a1[],a2[],a3[];
int BarWidth=1;
bool ChartDisplay=true; // false: use indicator_chart_window, true: use indicator_separate_window 
//+------------------------------------------------------------------+
