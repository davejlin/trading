...
//---- buffers
double TVI[],VU[],VD[],EMAU[],EMAD[],EMAU2[],EMAD2[],Sig[];
...
SetIndexBuffer(6,EMAU2);
SetIndexLabel(6, "EMA Up 2");
SetIndexStyle(7,DRAW_NONE);
SetIndexBuffer(7,EMAD2);
SetIndexLabel(7, "EMA Down 2");
...
/* for(i=limit;i>=0;i--)
 {   
  EMAU2[i]=iMAOnArray(EMAU,0,r,0,MODE_EMA,i);
  EMAD2[i]=iMAOnArray(EMAD,0,r,0,MODE_EMA,i);  
 }*/
