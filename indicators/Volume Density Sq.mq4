...
//|                                                         David J. Lin |
//| Displays Volume Squared per Price spread (Volume Squared Density)    |
//|                                                                      |
...
SetIndexBuffer(0,VD);
SetIndexLabel(0, "Volume Density Sq");
IndicatorShortName("Volume Density Sq");
//----
return(0);
}
//+------------------------------------------------------------------+
...
int start()
{
 ...
 for(i=limit;i>=0;i--)
 {
  ...
  VD[i]=Volume[i]*Volume[i]/MathMax(spread,1);
 }
 return(0);
}
//+------------------------------------------------------------------+ 