...
//---- name for DataWindow and indicator subwindow label
   short_name="Stochastic Channel Index Sto("+KPeriod+","+DPeriod+","+Slowing+")";
   ...
   while(i>=0)
     {
      ...
      while(k>=i)
        {
         price=iCustom(NULL,stochTimeFrame,IndexCustomIndicator,SymbolsPrefix,SymbolsSuffix,ShortTermMAperiod,ShortTermMAmethod,LongTermMAperiod,LongTermMAmethod,ShowLineValue,ShowBars,ShowCrossingDots,Identifier,colorBarDown,colorBarUp,colorBarNeutral,colorWickUp,colorWickDown,colorWickNeutral,widthWick,widthBody,alertsOn,alertsOnCurrent,alertsMessage,alertsSound,alertsEmail,modeLow,k);
   ...
   while(i>=0)
     {
      ...
      while(k>=i)
        {
         price=iCustom(NULL,stochTimeFrame,IndexCustomIndicator,SymbolsPrefix,SymbolsSuffix,ShortTermMAperiod,ShortTermMAmethod,LongTermMAperiod,LongTermMAmethod,ShowLineValue,ShowBars,ShowCrossingDots,Identifier,colorBarDown,colorBarUp,colorBarNeutral,colorWickUp,colorWickDown,colorWickNeutral,widthWick,widthBody,alertsOn,alertsOnCurrent,alertsMessage,alertsSound,alertsEmail,modeHigh,k);
   ...
   while(i>=0)
     {
      ...
      for(k=(i+Slowing-1);k>=i;k--)
        {
         sumlow+=iCustom(NULL,stochTimeFrame,IndexCustomIndicator,SymbolsPrefix,SymbolsSuffix,ShortTermMAperiod,ShortTermMAmethod,LongTermMAperiod,LongTermMAmethod,ShowLineValue,ShowBars,ShowCrossingDots,Identifier,colorBarDown,colorBarUp,colorBarNeutral,colorWickUp,colorWickDown,colorWickNeutral,widthWick,widthBody,alertsOn,alertsOnCurrent,alertsMessage,alertsSound,alertsEmail,modeClose,k)-LowesBuffer[k];
