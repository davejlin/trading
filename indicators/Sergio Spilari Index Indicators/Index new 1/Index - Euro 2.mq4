...
extern string Identifier       = "exyBars";
...
{
   IndicatorBuffers(8);
   SetIndexBuffer(0,diClose);  SetIndexLabel(0,"EXY");
   ...
   name = "("+Identifier+") Euro Index: EXY / "+ShortTermMAperiod+","+LongTermMAperiod; IndicatorShortName(name);
   return(0);
}
