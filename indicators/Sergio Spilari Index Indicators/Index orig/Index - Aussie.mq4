...
extern string Identifier       = "axyBars";
...
bool   returnBars;
string symbols[] = {"AUDUSD","AUDJPY","EURAUD","GBPAUD","AUDCHF","AUDCAD","AUDNZD"};
...
{
   IndicatorBuffers(8);
   SetIndexBuffer(0,diClose);  SetIndexLabel(0,"AXY");
   ...
   name = "("+Identifier+") Dollar Index: AXY / "+ShortTermMAperiod+","+LongTermMAperiod; IndicatorShortName(name);
   return(0);
}
