...
extern string Identifier       = "lxyBars";
...
bool   returnBars;
string symbols[] = {"GBPUSD","GBPJPY","EURGBP","GBPAUD","GBPCHF","GBPCAD","GBPNZD"};
...
{
   IndicatorBuffers(8);
   SetIndexBuffer(0,diClose);  SetIndexLabel(0,"LXY");
   ...
   name = "("+Identifier+") Pound Index: LXY / "+ShortTermMAperiod+","+LongTermMAperiod; IndicatorShortName(name);
   return(0);
}
