...
extern string Identifier       = "CANBars";
...
{
   IndicatorBuffers(8);
   SetIndexBuffer(0,diClose);  SetIndexLabel(0,"CAN");
   ...
   name = "("+Identifier+") Dollar Canadense Index: CAN / "+ShortTermMAperiod+","+LongTermMAperiod; IndicatorShortName(name);
   return(0);
}
