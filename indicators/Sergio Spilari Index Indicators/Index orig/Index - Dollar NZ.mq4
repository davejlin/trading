...
extern string Identifier       = "dxyBars";
...
bool   returnBars;
string symbols[] = {"NZDUSD","EURNZD","GBPNZD","NZDJPY","AUDNZD","NZDCHF","NZDCAD"};
...
{
   IndicatorBuffers(8);
   SetIndexBuffer(0,diClose);  SetIndexLabel(0,"DXY");
   ...
   name = "("+Identifier+") Dollar Index: DXY / "+ShortTermMAperiod+","+LongTermMAperiod; IndicatorShortName(name);
   return(0);
}
