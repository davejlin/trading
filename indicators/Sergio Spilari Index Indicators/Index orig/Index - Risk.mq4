...
extern string Identifier       = "risBars";
...
bool   returnBars;
string symbols[] = {"EURUSD","AUDUSD","GBPUSD","EURJPY","AUDJPY","GBPJPY","USDCHF","CHFJPY"};
double pows[]    = {0.100,0.100,0.100,0.100,0.100,0.100,-0.100,0.100};
...
{
   IndicatorBuffers(8);
   SetIndexBuffer(0,diClose);  SetIndexLabel(0,"RIS");
   ...
   name = "("+Identifier+") RISK Index: RIS / "+ShortTermMAperiod+","+LongTermMAperiod; IndicatorShortName(name);
   return(0);
}
