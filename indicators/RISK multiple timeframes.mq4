...
/* You can change any of the following arrays */
   ...
   string aPair[]   = {"EURUSD","GBPUSD","AUDUSD","NZDUSD","USDJPY","USDCHF","USDCAD","EURJPY","GBPJPY","AUDJPY","NZDJPY","CHFJPY","CADJPY","EURGBP","EURAUD","EURCHF","EURNZD","EURCAD","GBPAUD","GBPNZD","GBPCAD","GBPCHF","AUDCHF","AUDNZD","AUDCAD","NZDCAD","NZDCHF","CADCHF"};
                       
/* The following can also be changed but both must have the same dimension */
   string aMajor[] = {"USD","JPY","EUR","CHF","GBP","CAD","AUD","NZD"};
   int    aMajorPos[] = {150,130,110,90,70,50,30,10};
