...
IndicatorBuffers(8);
SetIndexBuffer(0,v1);
SetIndexStyle(0,DRAW_LINE,0,2,Color8);
SetIndexBuffer(1,v2);
SetIndexStyle(1,DRAW_LINE,0,2,Color7);
SetIndexBuffer(2,v3);
SetIndexStyle(2,DRAW_LINE,0,2,Color6);
SetIndexBuffer(3,v4);
SetIndexStyle(3,DRAW_LINE,0,2,Color5);
SetIndexBuffer(4,v5);
SetIndexStyle(4,DRAW_LINE,0,2,Color4);
SetIndexBuffer(5,v6);
SetIndexStyle(5,DRAW_LINE,0,2,Color3);
SetIndexBuffer(6,v7);
SetIndexStyle(6,DRAW_LINE,0,2,Color2);
SetIndexBuffer(7,v8);
SetIndexStyle(7,DRAW_LINE,0,2,Color1);
SetIndexLabel(0, "CP L8");
SetIndexLabel(1, "CP L7");
SetIndexLabel(2, "CP L6");
SetIndexLabel(3, "CP L5");
SetIndexLabel(4, "CP L4");
SetIndexLabel(5, "CP L3");
SetIndexLabel(6, "CP L2");
SetIndexLabel(7, "CP L1");
//----
switch (MAType)
   {
...
int start()
  ...
  v1[i]=Line8;v2[i]=Line7;v3[i]=Line6;v4[i]=Line5;
  v5[i]=Line4;v6[i]=Line3;v7[i]=Line2;v8[i]=Line1;
